    ...
    <div className="frame">
      <div id="landing" className='robot-layout'>
        ...
        <div className="robots">
          <img src={robot1} alt="green robot, no mouth, 0 antenna, 2 arms, 3 buttons"></img>
          <img src={robot2} alt="red robot, with mouth, 2 antenna, 2 arms, 3 buttons"></img>
          <img src={robot3} alt="green robot, with mouth, 2 antenna, 2 arms, 3 buttons"></img>
