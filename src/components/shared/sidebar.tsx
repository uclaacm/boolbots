...
function Sidebar(props: SidebarProps): JSX.Element {
  ...
  const pages = ['/','/variable','/equal','/comparison','/boolean','/advanced','/output','/python','/experiment', '/extension',];
  const desc = [
    ...
    'Congratulations, you have finished the BoolBots Learning Lab! You can change the code to assign your own values to the variables and statements. Check out how the output changes! Once you have finished, we can move on to an application of booleans called if-statements',
  ];
